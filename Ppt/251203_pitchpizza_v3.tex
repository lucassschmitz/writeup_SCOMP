...
\begin{column}{0.48\textwidth}
    ...
    $$ \underbrace{Offer \\ improvement}_{F_{ij}^R - F_{ij}^I} = \beta_0 + \beta_1 \text{Avg. gap}_{ij} + \beta_2 \text{Max. gap}_{ij} + \beta_j + \epsilon_{ij}$$
    where  \\
...
\begin{itemize}
    ...
    \item If low-risk consumers search, the second stage improves selection and disciplines initial offers for everyone.
