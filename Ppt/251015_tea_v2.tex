...
\begin{frame}{Learning} 
    ...
    \begin{itemize}
        \item $$ F_{ij}^R - F_{ij}^I = \beta_0 + \beta_1 \left(\frac{1}{J-1}\sum_{k \neq j} F_{ik}^I\right) + \epsilon_{ij}$$
        
        \item $$ \mathbb{1} (F_{ij}^R  - F_{ij}^I)  = \alpha_0 + \alpha_1 \left(\frac{1}{J-1}\sum_{k \neq j} F_{ik}^I\right) + \epsilon_{ij}$$
    \end{itemize}
