...
Following \textcite{allen_search_2019} we assume that consumers are price takers but sellers do not know their search cost.

The firm that creates the highest surplus wins the auction, making an offer that leaves the consumer indifferent between accepting the offer or the second next offer. Without loss of generality assume that firm $j$ creates the $j$-th highest surplus, then firm $1$ offer is: 
