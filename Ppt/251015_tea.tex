...
\begin{center}
\input{../figures/tikz/SCOMP_diagram.tex}
\end{center}
\begin{itemize}
    \item \hyperlink{slide:fig5}{\beamerbutton{Offer Certificate}}
\end{itemize}
\end{frame}
...
\end{tabular}
\end{figure}
\hyperlink{slide:setting}{\beamerbutton{Go back: Diagram}} 
\hyperlink{slide:setting}{\beamerbutton{Go back: Data}}
\end{frame}
