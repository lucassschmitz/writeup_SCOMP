...
The interaction between search and selection is governed by the joint density of search costs and risk types. Buyers decide whether to search based on their search cost and the expected benefit from searching, which depends on their type.
